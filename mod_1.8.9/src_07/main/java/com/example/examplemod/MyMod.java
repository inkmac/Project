...
import com.example.examplemod.event.PlayerDirectionHandler;
import com.example.examplemod.event.PlayerLoginEventHandler;
import com.example.examplemod.event.PlayerLogoutEventHandler;
...
public class MyMod {
    ...
    public void init(FMLInitializationEvent event) {
        ...
        MinecraftForge.EVENT_BUS.register(new PlayerLogoutEventHandler());
    }
